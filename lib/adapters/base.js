...
class BaseAdapter {
  ...
  constructor (config, logger) {
    ...
    this._retryCount = this._config.retryCount || 5; // number of automatic retries before giving up
    this._retryBackoff = 250; // milliseconds between retries... increases linearly
    this._remainingRetries = this._retryCount;
    this._requests = {};
  }
